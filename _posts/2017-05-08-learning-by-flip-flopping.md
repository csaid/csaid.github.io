...
For most of the example sequences in this blog post, I prefer the flip-flopping metaphor, since all of the sequences involve alternations between "pro" and "con" positions, a condition that AFAICT is not required for Hegelian dialectic. On the other hand, some of the stage transitions (for example the last stage of the Recessions example) are probably best described as a synthesis of previous stages that is neither "pro" nor "con".
